...
> **Current AV-BS1 H4-P0R-P1 boundary:** six public P1 invocations are immutable and all six one-use tokens were retired without reuse. The sixth used token-only commit `82775327d79742b6c3111ad33a87fd1a4953ee79`, child of clean retry-v5 contract `bddbf9cb3547ae0385c6e6bbc47424f630cca87e`, created claim `a3f49b44dd164da3a0ca1a6dc4c976c3`, and launched factor child PID `55380`. Its provisional numerical wrapper failed before `_factor_one`/`splu` on `claimed preflight payload mismatch` and proves `factorization_attempted=false` and `factorization_performed=false`; no factor prefix, certificate, RHS, solve, H4 physics, or PowerSI work exists. Independently, outer close SHA-256 `d2777207e4000cbde8e4bf2332eeba96dd54ec3b8918a0d107049531d15cd8f8` stopped on attempt-3 `TRANSIENT_DESCENDANT_DISAPPEARANCE_RETRY_EXHAUSTED` for PID `53404`, retained all `30/30` retry events with `tree_sample_retry_events_truncated=false`, verified cleanup, and wrote no seal. Resource ceilings were not approached. Emergency replacement produced an exact and honest but strict-validator-invalid provisional consumed record because nested `bindings.resource_policy_sha256` was omitted; commit `06061a234ad7b1b911d7425b7765482bda58a87a` preserves it and deletion-only retirement `c001b4498fc750b5955f5118844945c499fce119` removes the token. Retry-v6 deletes only the redundant three-line post-claim preflight comparison and adds only the missing emergency binding key; schema, ABI, validator strictness, retry policy/cap, factor, RHS, solve, and physics logic remain unchanged. Frozen SHA-256 bindings are Python `2373a13f51e2833e416e1ce6326587b9e1c782b5165d99f7002e7dbc4658ebc4`, runner `852ce8a03b25e33b9eb26ec6f5ce295381dab493b1b26762ddea14be7196000d`, and tests `f1d0b044cbf53e90dba128ec398ccd8b7a81da8c5137bea202b2852eb3f288af`; focused `8/8` and full no-cache `330/330` passed, the latter in `81.83 s`. Current token state is absent, factor fit remains unproven, and `next_stage_authorized=false`. See the [results](docs/evaluation-research/T1_AV_BOUNDARY_SCHUR_RESULTS.md) and [P1 preregistration](docs/evaluation-research/T1_AV_BOUNDARY_SCHUR_H4_P0R_P1_PREREG.md).
