        ...
        assumptions=(
            *working.assumptions,
            ...
            (
                ...
                if not external_terminal_complete
                else "modal convergence: not applicable; terminal-complete external Device-port input is analytically invariant to rectangular modal order"
            ),
        ),
    )
