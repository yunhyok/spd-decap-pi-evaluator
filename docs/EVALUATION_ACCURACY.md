...
exact query once exited0 with exactly 2 lines/1 file at validator definitions 1280/1323. 17BM is DONE/PASS
at clean main `7d5eb16d67d9d98fad3a89939819eb4f30e45b80`: exact1280-1359 was locally complete for
fields/types/units/order/group/hash/gaps and primitive layer/net/source bindings, but island/surface
identity and physical ownership remain unproven/BLOCKED. Sole ACTIVE read-only successor is 17BN, the
two-file bounded typed-row facade (`raw_spatial_contact_asset.py` plus compiler test) with at most one
focused node after Sol static review. Preserve existing fields/order/counts/closed failure; no new
schema/join/helper/attachment/manifest/hash or physical/profile/solver/production/accuracy claim.
