...
Sole ACTIVE successor 17CW `W7-PHYS-W6-PLANE-PRIMITIVE-ATTACHMENT-DIGEST-CACHE-OWNER-BOUNDARY-DISCOVERY` authorizes exactly one defs-boundary location query:
