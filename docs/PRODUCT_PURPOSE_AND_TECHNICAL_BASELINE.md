...
accuracy/causal claim. Sole ACTIVE successor is
...
reread. Resolve owner/opt-in no-fallback profile/loader require flag, hash-bound solve handoff,
new-profile-only replacement and no-double-counting, differential/nullspace/gauge and rail-order Zii,
