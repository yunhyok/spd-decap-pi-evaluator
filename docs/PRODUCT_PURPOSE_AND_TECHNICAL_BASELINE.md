...
- 17AS/17AT/17AU authority: 17AS DONE-negative at clean main `9dba3076b6648e7aeb874c96fa721997e1629bb3` (query once, exit0, 6 lines/1 file; zero actual caller). 17AT BLOCKED/implementation REJECT after one frozen-evidence design pass; all six bindings UNPROVEN. Sole ACTIVE is 17AU `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-BOUNDARY-DISCOVERY`.
- 17AT closure: BLOCKED/implementation REJECT after one frozen-evidence design pass; all six bindings remain UNPROVEN. Sole ACTIVE successor is 17AU `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-BOUNDARY-DISCOVERY`.
...
and minimal file/test/V1/V2 whitelist. Sole ACTIVE successor is 17AU
`W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-BOUNDARY-DISCOVERY`, limited to its exact once query; no
code/test/source/production/PowerSI/profile/solver/accuracy/causal claim.
