...
- 현재 권위 상태: sole ACTIVE 17CD `W7-PHYS-W6-RAW-SURFACE-PARSE-LAYERS-MAP-BINDING-TRACE`; one `Get-Content` invocation emits excerpts A872-940 (69 lines) and B1038-1067 (30 lines) once each, total99 new lines, skipping941-1037. PASS requires complete signature/normalization/rows/by_fold/constructor/append in A and key generation/duplicate guard/by_fold binding/final return in B; short/mismatched output, endpoint truncation, skipped indirect mutation, or external helper semantics is nonzero STOP/no retry/no expansion. Decode/SHA/source hash/islands/ownership/stamp/profile/replacement/nullspace/Zii/production/accuracy/release remain excluded.
...
by_fold899, append917, constructor918, insert1058, return1065. Sole ACTIVE successor is 17CD, a split map-binding
trace.

17CD authorizes one `Get-Content` invocation emitting excerpts A872-940 (69 lines) and B1038-1067 (30 lines) once
each, total99 new lines, skipping941-1037. PASS requires complete A signature/normalization/rows/by_fold/constructor/
append and B key generation/duplicate guard/by_fold binding/final return, with short/mismatched output, endpoint
truncation, skipped indirect mutation, or external helper semantics producing nonzero STOP/no retry/no expansion.
Decode/SHA/source hash/islands/ownership/stamp/profile/replacement/
nullspace/Zii/production/accuracy/release remain excluded.
