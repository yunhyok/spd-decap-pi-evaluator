...
- 상태: **G0 기준 문서** — W5 DONE; W6-BASE 260729 numerical FAIL; W7-SOURCE-IR Phase 1/2/3/4와 W7-PHYS-PROSPECTIVE-P0/P1/P2/P4/P5/P6/P7/P8/P9/P10/P11 DONE, P3/P11 DONE/STOP (모두 shadow/prerequisite 범위); Actual-P0/R1/R2와 R2-MULTI-TOPOLOGY-DIAG-01 및 Recovery-01은 DONE/STOP, FIX-01/FIX-02는 DONE/ACCEPT다. `W7-PHYS-SOURCE-ANCHOR-LEAN-DSU-EVIDENCE-01`은 DONE/`STOP_TARGET_CONTACT_MISSING_OR_AMBIGUOUS`다.
  `W7-PHYS-SOURCE-ANCHOR-LEAN-DSU-EVIDENCE-02`만 ACTIVE이며 W7 production physics는 아직 BLOCKED다.
...
- Sole ACTIVE item (current): **`W7-PHYS-SOURCE-ANCHOR-LEAN-DSU-EVIDENCE-02`** — DSU-01은 `STOP_TARGET_CONTACT_MISSING_OR_AMBIGUOUS`로 영구 종료했으며, DSU-02 lean producer-time observer만 진단 목적으로 유지한다. production wiring, topology 승격과 P12는 열지 않으며, 실제 source invocation은 별도 contract/self-check/Sol ACCEPT gate 이후에만 가능하다.
...
- coordinator freeze: DSU-01 `source_anchor_lean_dsu_evidence.py`는 contract `fb45d2fdb9c7e447935073e082ac557209a317f6`에서 `STOP_TARGET_CONTACT_MISSING_OR_AMBIGUOUS`로 영구 종료했다. sole ACTIVE DSU-02는 `D:\SPD-Decap-PI-Evaluator-W7\_coordinator_temp\source_anchor_lean_dsu_evidence_v2.py` (110,605 bytes, SHA-256 `b9d56f959b9a7795b6dbb83fd6e33c515c91d19c97c845f5614d31e33c792092`)이며 final exact-hash self-check PASS, measured `196.06 B/target vertex <=256 B`와 Sol ACCEPT를 기록한다. DSU-02 contract는 `fb45d2fdb9c7e447935073e082ac557209a317f6`의 단일 docs-only child여야 한다. 원본 SPD는 `D:\S4LB002-2Para_260729_1_injected.spd` (1,116,717,287 bytes)이며 observer source SHA는 `40cb44b2376f59d6b606eb9b4d138204fe51b2dc6b3332d3b7c0e7d4202866d2`와 exact 일치해야 한다. 정상 DSU-02 observer-reached 경로는 import/analyze/observer/report `1/1/1/1`, retry 0이고 runtime guard만 계수한다.
