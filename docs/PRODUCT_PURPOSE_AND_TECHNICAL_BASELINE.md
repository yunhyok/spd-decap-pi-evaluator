...
- Sole ACTIVE item (current): 17DO `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-CONCRETE-ROW-FRESH-RUN`; 17DM is permanently BLOCKED/execution STOP and 17DN is DONE/PASS.
...
Exact raw/candidate inputs and hashes are unchanged; implementation commit `ea78c0181aa98c565efedf1b3b19e2117decdcd7`; fresh root `D:\SPD-Decap-PI-Evaluator-W7\ea78c0181aa98c565efedf1b3b19e2117decdcd7\260729-17do-source-coverage`. Immediate Usage Guard, clean-main/code-match, input existence/size, and output-root absence checks precede exactly one production run with no retry. PASS/STOP uses the strict source-coverage gate; failures are execution/source-coverage STOP, never accuracy FAIL. 17DM is permanently stopped and outputs are not reused.
