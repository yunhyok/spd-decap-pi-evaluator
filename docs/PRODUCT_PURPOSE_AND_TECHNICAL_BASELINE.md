...
delegated; absence is not evidence. Sole ACTIVE successor is
...
17AD itself opens no files. No code/test/profile/accuracy/production proof or whitelist expansion is
authorized.
