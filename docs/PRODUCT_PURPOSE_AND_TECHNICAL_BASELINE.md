...
- current accuracy gate continuation: **D102/D103/D104 DONE / PASS — D105 DOWNLOAD_ONLY / STATIC_AUDIT_DONE — D106 EXTRACTED / VERSION_PROBE_PASS — D107S PASS — D107T PASS — D107U STOP_STRICT_OUTPUT_NONFATAL_REGISTRY_DIAGNOSTIC — D109R ACCEPT_AFTER_CONTRACT_CORRECTION — D110/D112R/D114 PASS — next: D104 production input contract**
...
- D107S는 `--timestamps=none`의 innoextract 1.9 Windows explicit-close 우회로 Boost 4100-byte buffer tail loss를 확인했고, `History.txt` UTC discriminator 2805 bytes SHA1 `f90f0d6a4566976188628f95cd8e31b5edaf32aa`는 PASS다.
- D107T는 UTC full filtered extraction PASS (16 files/3 dirs/7,617,034 bytes)이며 `FasterCap.exe` 7,211,520 bytes SHA256 `02806e5b185d3cf86f9ed95e7e732fdec1bae0fdc9344f064d90550f5861c9b9`, `libgomp` SHA256 `68d15bf2180388c396e01d3ef3a3e5987e04d544e1a2a39e04f51e75f76984c9`다. prior D107/D107R는 NO_REUSE다.
...
- main fixture generator/topology test는 `bf4ea80`, `3344757`, `9068a13`, `fd2ed82`에 반영됐고 focused test는 1 passed다. D109R은 원 wrapper가 stale raw==solver 계약으로 STOP된 뒤 source-corrected Q→2 triangles 계약(raw/solver/after=960/1920/1920)을 본부가 ACCEPT한 것이다. D109R coarse는 66,533 KiB, 0.290 s; D110 medium은 3504/7008/7008, 396,793 KiB, 2.233 s; D112R fine은 13344/26688/26688, 685,597 KiB, 4.438 s다. all physical gates PASS, adaptive refinement/OOC 없음, registry startup diagnostic만 exact이며 FasterCap exit code는 source defect 때문에 oracle이 아니다.
