...
selected. 17Z is DONE. Sole ACTIVE 17AA
`W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION` is bounded to
`raw_spatial_contact_asset.py`, `raw_spatial_contact_compiler.py`, `surface_certificate_asset.py`, and
`tests/test_raw_spatial_contact_compiler.py`; canonical docs remain state-only.
