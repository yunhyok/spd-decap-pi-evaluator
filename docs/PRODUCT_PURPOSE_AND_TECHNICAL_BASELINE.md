...
Sole ACTIVE successor 17CT `W7-PHYS-W6-PLANE-PRIMITIVE-SOURCE-ASSET-SHA-DIGEST-VALIDATION-USE-DISCOVERY` authorizes exactly one validation-use query:
