...
- 상태: **G0 기준 문서** — W5 DONE; W6-BASE 260729 numerical FAIL; W7-SOURCE-IR Phase 1/2/3/4와 W7-PHYS-PROSPECTIVE-P0/P1/P2/P4/P5/P6/P7/P8/P9/P10/P11 DONE, P3/P11 DONE/STOP (모두 shadow/prerequisite 범위); Actual-P0/R1/R2와 R2-MULTI-TOPOLOGY-DIAG-01 및 Recovery-01은 DONE/STOP, FIX-01/FIX-02는 DONE/ACCEPT다. `W7-PHYS-SOURCE-ANCHOR-LEAN-DSU-EVIDENCE-01`은 DONE/`STOP_TARGET_CONTACT_MISSING_OR_AMBIGUOUS`다.
  ...
  W7 production physics는 BLOCKED이고 sole ACTIVE는 **W7-PHYS-OWNER-JOIN-COMPACT-REQUEST-BOUND-FIX-01 / FROZEN / READY_FOR_IMPLEMENTATION**이다. Original-SPD EVIDENCE-01/-02/-04는 DONE/STOP_IMPORT_OR_OWNERSHIP, EVIDENCE-03은 DONE/STOP_UNEXPECTED로 영구 닫혔고 quotient-scope FIX-01과 terminal pad-layer test-oracle FIX-01은 DONE/ACCEPT다.
...
- Sole ACTIVE item (current): **W7-PHYS-OWNER-JOIN-COMPACT-REQUEST-BOUND-FIX-01 / FROZEN / READY_FOR_IMPLEMENTATION** at base `0775f38e9d569e3144f8aac56729d8cabc3e61e1`. Delete only the provisional aggregate calculation/STOP in `spd_adapter.py`; preserve `compact_draft`, every local/raw/final 100,000-row cap, terminal source-layer semantics and all schema. One new focused synthetic node may run once after Sol static acceptance. Improvement remains 0.
...
- 현재 권한: main-only와 `accuracy_parse.py` 보존을 유지한다. Luna는 frozen five-file whitelist 안에서 aggregate block 삭제와 신규 test node만 작성한다. Sol static ACCEPT 뒤 그 node를 정확히 1회 실행한다. Cap/SQLite/schema/raw compiler/solver/original-SPD/full-suite/production/PowerSI 작업은 금지한다.
...
| 현재 ACTIVE | **W7-PHYS-OWNER-JOIN-COMPACT-REQUEST-BOUND-FIX-01 / FROZEN / READY_FOR_IMPLEMENTATION** |
| 현재 gate | redundant provisional aggregate block만 삭제; local/raw/final 100,000-row caps 보존; 신규 focused node 1회 |
...
## 23. W7-PHYS-OWNER-JOIN-COMPACT-REQUEST-BOUND-FIX-01 — FROZEN / READY_FOR_IMPLEMENTATION
