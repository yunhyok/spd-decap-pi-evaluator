...
- 현재 권위 상태: sole ACTIVE 17CP `W7-PHYS-W6-PLANE-PRIMITIVE-SOURCE-ASSET-FIELD-BINDING-TRACE`; exact once-only body read compiler.py lines803-818, 16 lines, requiring missing lookup fail-closed, record asset/asset_sha256 validation and unchanged transfer to primitive source fields. Endpoint/delegated validation, alias/default/synthesis, or incomplete expression STOP/no expansion. Bounded body read only; no source expansion/requery, islands/ownership/stamp/profile/replacement/nullspace/Zii/production/accuracy/release excluded.
...
17CO is BLOCKED/source-classified STOP at clean HEAD `4df620768744bd8563cacf430ffca19e6c3eb535`: the exact 23-line body read ran once with exit0 and proved plane_geometries records, raw/analysis key guards, and line802 lookup, but asset/asset_sha256 validation and preservation were absent. No expansion or retry occurred. Sole ACTIVE successor is 17CP, a source-asset field-binding body trace.
17CP authorizes one exact 16-line body read:
...
17CP PASS only if missing lookup fail-closed, record['asset'] and ['asset_sha256'] existence/format validation, unchanged transfer to primitive source fields, and complete line818 expression are present. Earlier/delegated validation, alias/default/synthesis, or an open endpoint => BLOCKED/STOP; no expansion or retry. Body scope only; islands/ownership/stamp/profile/replacement/nullspace/Zii/production/accuracy/release excluded.
