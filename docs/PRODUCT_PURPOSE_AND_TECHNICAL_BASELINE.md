...
- 현재 권위 상태: sole ACTIVE 17CJ `W7-PHYS-W6-RAW-SPATIAL-GEOMETRY-ATTACHMENT-SHA-CONTRACT-TRACE`; exact once-only numbered read of compiler.py lines2292-2362 (71 lines). PASS requires attachment bytes plus provided asset_sha validation order, decode/parse, cancellation/bounds/error conversion/return, and raw surface asset_sha bound to attachment content; external essential SHA/normalization/parser or incomplete boundary STOP/no expansion/retry. Body trace only; island/source-hash/ownership/stamp/profile/replacement/nullspace/Zii/production/accuracy/release excluded.
...
17CJ authorizes only the exact once-only numbered read of `raw_spatial_contact_compiler.py` lines2292-2362 (71 lines).
PASS requires attachment bytes plus provided asset_sha validation order, decode/parse, cancellation/bounds/error conversion/
return, and raw surface asset_sha bound to attachment content; external essential SHA/normalization/parser or incomplete
boundary STOP/no expansion/retry. Body trace only; island/source-hash/ownership/stamp/profile/replacement/nullspace/Zii/
production/accuracy/release remain excluded.
