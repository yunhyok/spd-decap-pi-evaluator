...
- Sole ACTIVE item (current): 17DM `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-FRESH-RUN`; 17DK remains permanently BLOCKED/execution STOP and 17DL is DONE/PASS.
...
Exact raw/candidate inputs and hashes are retained from 17DK; implementation HEAD is `524b26dd1f20933011139a520e4e95dbf9e98b84`, fresh output root `D:\SPD-Decap-PI-Evaluator-W7\524b26dd1f20933011139a520e4e95dbf9e98b84\260729-17dm-source-coverage`. Usage Guard, output/progress pre-existence, and one-run/no-retry checks precede the audit. PASS/STOP uses the 17DK strict source-coverage gate; failures are SOURCE-COVERAGE or execution STOP, never accuracy FAIL. 17DK outputs are not reused.
