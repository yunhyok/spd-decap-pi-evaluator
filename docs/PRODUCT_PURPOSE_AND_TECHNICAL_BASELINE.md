...
owner selected. Sole ACTIVE successor is
`W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-TEST-SEAM-TRACE` (17AK), authorizing exactly two excerpts
from the same test file, A lines 2284-2312 (29) and B lines 2468-2505 (38), total <=67; no
owner-wide read/search/other range. Endpoint truncation => STOP; only opt-in seam viability may be
concluded while default-v2 tests stay separate. No owner-wide read/search, code edit, test execution, or profile/accuracy/production inference.
