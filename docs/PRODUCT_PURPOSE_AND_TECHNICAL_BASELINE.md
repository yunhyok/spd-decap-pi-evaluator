...
current-spreading term; W6 inputs/asset fidelity remain external. The sole ACTIVE successor is
`W7-PHYS-PLANE-SHEET-RL-REUSE-DISCOVERY`, limited to one `rg -n -i` pass in
`src/spd_decap_pi/_core/solver` from clean HEAD `7cf6d6072777750a5932ac3f68710d11e1f5e2e1`.
