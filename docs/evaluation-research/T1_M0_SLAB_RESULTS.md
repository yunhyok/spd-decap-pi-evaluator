...
| finite-width M1 | G1 exterior-only, G2 pair-only; 100 kHz circle reciprocity/cancellation fail | planned G2 2 GHz circle/N512/EQ0 seed/terminal 미실행 | SAO–CIM/A–v 정확도 |
