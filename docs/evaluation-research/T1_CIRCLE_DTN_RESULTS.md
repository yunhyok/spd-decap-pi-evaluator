...
| independent A–v | `2GHz_4Deff_smoke_only`; circle boundary-Schur `preregistered_not_run` | noncircular same-basis cross-method와 circle mesh/crop convergence 미실행 |
