...
def run(output: Path) -> dict:
    ...
    require(l02_drive == (POSITIVE, NEGATIVE, GAUGE)
            ...
            and l02_sheet_active[0] == L02_TARGET
    ...
    warm_v[L25_SIZE:] = prior_v25[L02_TARGET] + (prior_v02[NATIVE_SIZE:] - prior_v02[L02_TARGET])
    warm_v -= warm_v[GAUGE]
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path,
                        default=R / "astra-l02-l14-l25-combined-block-gmres-02")
