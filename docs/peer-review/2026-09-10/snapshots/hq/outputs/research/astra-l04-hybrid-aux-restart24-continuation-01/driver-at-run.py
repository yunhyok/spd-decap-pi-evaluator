"""SPD Decap PI Evaluator v0.23.1: disabled saved-field restart24 right-GMRES research probe."""
import argparse
import ctypes
...
INTERNAL_SECONDS, EXTERNAL_SECONDS, MEMORY_GIB = 690., 720., 32.
RTOL, RESTART, MAX_CYCLES = 1e-9, 24, 2
...
PINS.update({
 ...
 'predecessor_driver': (R/'astra-l04-hybrid-aux-bounded-right-gmres-01/driver-at-run.py', '791e60b4f9a5699a2f7c0f34f67243e1b77d29c13da6dd5a8c626bc1fb59b677'),
 'predecessor_result': (R/'astra-l04-hybrid-aux-bounded-right-gmres-01/result.json', '39cac05d26d6881e618c4993966fcf9bca1d6627b18f4a2d2ae0aadf70fe1d65'),
 'predecessor_external': (R/'astra-l04-hybrid-aux-bounded-right-gmres-01/external-budget.json', '236ad0b8ab0bda75aae1cffcf3e1b774ba72b35267ee6c4e8175a91484ce50f6'),
 'warm_field': (R/'astra-l04-hybrid-aux-bounded-right-gmres-01/restart-2-unvalidated-field.npz', '1c583087643ef55eb0b00e42b9111bddfc5413ed527c7581ef9dcf3bc871c064'),
})
...
def self_check():
 ...
 print('PASS_SAVED_FIELD_RESTART24_RIGHT_CORRECTION_RECOVERY')
...
def verify_inputs():
 ...
 assert result['best_relative']==0.05037716844311692 and result['rtol']==RTOL
...
def worker(output):
 ...
 try:
  ...
  assert np.isclose(initial_relative,0.05037716844311692,rtol=1e-8,atol=0)
  ...
  result=dict(program=PROGRAM,version=VERSION,status='MEASURED_BOUNDED_HYBRID_AUX_RIGHT_GMRES',
              ...
              scope='At most two restart24 cycles from the saved bounded-run best field. '
