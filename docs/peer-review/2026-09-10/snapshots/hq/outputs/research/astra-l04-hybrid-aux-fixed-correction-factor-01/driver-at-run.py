"""SPD Decap PI Evaluator v0.23.1: disabled fixed-correction hybrid-H auxiliary probe."""
...
PINS = {
    ...
    'prior_factor_diagnostic': (R/'astra-l04-hybrid-aux-native-compact-factor-01/compact-factor-diagnostic.json', 'c6ab690e2c33606fd8eb90e18f2c4e3b30edbaa2bf9d38b1ca33309bb8754a65'),
    'prior_factor_failure': (R/'astra-l04-hybrid-aux-native-compact-factor-01/failure.json', '2e25d4a763857241536dfd0a19ab29f5f0d86e55bd448557c43be3a2f32d3366'),
    'prior_factor_external': (R/'astra-l04-hybrid-aux-native-compact-factor-01/external-budget.json', '0caa1d368b4a0db2c26fd2e1936dcf00e5a5a7b42c249c7c3c2d76f7ddb3563a'),
    'saved_residual_diagnostic': (R/'astra-l04-hybrid-aux-native-compact-factor-01/hq-saved-factor-residual-diagnostic.json', '8ea8a8121558719168f97bbb3b836a6b5d89c63c8315866f901d8d6821e3144d'),
    'saved_fsum_diagnostic': (R/'astra-l04-hybrid-aux-native-compact-factor-01/hq-saved-factor-fsum-diagnostic.json', '7207a5257577852747f98b687f1433627da5c736830f92dd8af59fbf398c5fb5'),
...
def worker(output: Path) -> None:
    ...
    try:
        ...
        base.atomic_json(output / "result.json", {"program": PROGRAM, "version": VERSION, "status": "PASS_FIXED_CORRECTION_HYBRID_AUX_NATIVE_L04_FACTOR_SINGLE_PROBE", "physical_operator_replacement_accepted": False, "preconditioner_candidate_only": True, "driver": receipt(frozen), "inputs": inputs, "artifact": receipt(artifact), "diagnostic": receipt(diagnostic), "metrics": metrics, "budget": budget.receipt(), "scope": "One fixed residual correction B1=2B-BAB, with original 2e-8 gates. Auxiliary-only native+L04 hybrid factor; physical trace equivalence remains failed. Exact ContactNtD remains the true operator; no global solve, field, new Z, or accuracy claim."})
