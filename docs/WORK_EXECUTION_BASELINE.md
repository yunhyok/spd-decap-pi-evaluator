...
| candidate staging / acceptance | product 3 + tests 3 only; existing SQLite spool reuse; external v2 schema/ledger invariant; Sol static 뒤 focused invocation 1회; original SPD/full suite 금지 |
