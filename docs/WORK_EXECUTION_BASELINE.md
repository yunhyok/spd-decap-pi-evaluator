...
- 문서 버전: **1.67**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.66
...
| `W7-PHYS-W6-RAW-SPATIAL-V3-PRODUCTION-IMPORT-CALLER-TRACE` | 17AP | ACTIVE | trace the selected production import caller boundary | exactly once read `src/spd_decap_pi/gui/main_window.py` lines1838-1895 (58 lines); require complete worker boundary, call args, progress/cancellation, return/error handling, and local product/profile opt-in setting; boundary truncation => STOP without extension; no code/test/production/accuracy claim |
...
### 17AP. W7-PHYS-W6-RAW-SPATIAL-V3-PRODUCTION-IMPORT-CALLER-TRACE (ACTIVE)

Authorize exactly once reading `src/spd_decap_pi/gui/main_window.py` lines1838-1895 (58 lines). Require
complete worker boundary, call arguments, progress/cancellation, return/error handling, and whether a
local product/profile opt-in setting exists. Any boundary truncation => STOP without extension. No
code/test/production/accuracy claim.
## 20. 변경 기록
