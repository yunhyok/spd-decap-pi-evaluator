...
- 문서 버전: **1.145**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.144
...
- Sole ACTIVE item (current): 17DN `W7-PHYS-COMPILED-ANCHOR-BINDING-CONCRETE-ROW-ADAPTATION`; 17DM permanently BLOCKED/execution STOP and 17DL DONE/PASS.
- The historical chain's terminal `ACTIVE NONE. Any implementation remains gated.` wording is superseded: sole ACTIVE is 17DN under the exact whitelist.
...
| 현재 active work item | 17DN `W7-PHYS-COMPILED-ANCHOR-BINDING-CONCRETE-ROW-ADAPTATION` (ACTIVE) |
| 다음 권장 묶음 | 17DN exact whitelist and focused node once; no production run |
| current authorization | exact 17DN whitelist and focused node only; 17DM permanently stopped with no rerun/reuse |
...
| `W7-PHYS-COMPILED-ANCHOR-BINDING-CONCRETE-ROW-ADAPTATION` | 17DN | ACTIVE | compiled anchor binding concrete-row adaptation | exact two-file whitelist; focused node once after Sol ACCEPT; no production run |
...
### 17DN. W7-PHYS-COMPILED-ANCHOR-BINDING-CONCRETE-ROW-ADAPTATION (ACTIVE)
