...
- 문서 버전: **1.146**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.145
...
- Sole ACTIVE item (current): 17DO `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-CONCRETE-ROW-FRESH-RUN`; 17DM permanently BLOCKED/execution STOP and 17DN DONE/PASS.
- The historical chain's terminal `ACTIVE NONE. Any implementation remains gated.` wording is superseded: sole ACTIVE is 17DO under the exact whitelist.
...
| 현재 active work item | 17DO `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-CONCRETE-ROW-FRESH-RUN` (ACTIVE) |
| 다음 권장 묶음 | 17DO immediate Usage Guard/prechecks, then one fresh production audit/no retry |
| current authorization | exact 17DO audit only; 17DM permanently stopped/no reuse; no unrelated build/release authority |
...
| `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-CONCRETE-ROW-FRESH-RUN` | 17DO | ACTIVE | fresh strict source-coverage audit after concrete-row adaptation | exact inputs/hashes; prechecks; one production run/no retry |
...
### 17DO. W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-CONCRETE-ROW-FRESH-RUN (ACTIVE)

Exact raw/candidate inputs and hashes are retained; implementation commit `ea78c0181aa98c565efedf1b3b19e2117decdcd7`; fresh root `D:\SPD-Decap-PI-Evaluator-W7\ea78c0181aa98c565efedf1b3b19e2117decdcd7\260729-17do-source-coverage`. Immediately before one production audit: Usage Guard, clean main/code-match, input existence/size, and output-root absence checks. One run/no retry; strict source-coverage PASS/STOP semantics; failures are execution/source-coverage STOP, never accuracy FAIL. 17DM permanently stopped; no output reuse.
