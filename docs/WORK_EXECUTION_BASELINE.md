...
- 문서 버전: **1.73**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.72
...
- 17AT BLOCKED/implementation REJECT after one frozen-evidence design pass; all six bindings remain UNPROVEN. 17AU DONE (location evidence) at clean main `9f1c95fa0a933445bbb918aff050fcb6238b1e6b`. Sole ACTIVE 17AV: `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-CALLSITE-TRACE`.
...
| 현재 active work item | `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-CALLSITE-TRACE` |
| 다음 권장 묶음 | `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-CALLSITE-TRACE` (ACTIVE; one exact 120-line read) |
| current authorization | 17AU DONE (location evidence): exact query once exit0, 22 lines/2 files; raw loader/require cluster 2460-2477 unique; evaluation build cluster formed by profile resolution 2363 plus build import 2404/call 2420; no source range/code/test/claims. Sole ACTIVE 17AV authorizes exactly one read of evaluation.py lines2330-2449; no other source/search/code/test/production/PowerSI/profile/solver/accuracy/causal execution. |
...
| 고비용 검증 권한 | none; only the low-cost bounded 17AV 120-line read is authorized, with no other source/search/code/test/production execution |
...
| `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-CALLSITE-TRACE` | 17AV | ACTIVE | trace the evaluation handoff callsite | exactly one read `src/spd_decap_pi/evaluation.py` lines2330-2449 (120); require enclosing function/branch/profile, attachments/raw manifest, build inputs/return, worker/cancellation/resource, downstream solver/return, and v3 loader hash-bound/fail-closed ownership; endpoint truncation => STOP/no extension; no code/test/production/profile/solver/accuracy/causal claim |
...
### 17AV. W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-HANDOFF-CALLSITE-TRACE (ACTIVE)
