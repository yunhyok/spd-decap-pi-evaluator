...
- 문서 버전: **1.70**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.69
...
- 상태: **APPROVED/MACHINE-FROZEN CONTROL DOCUMENT — W5 DONE; W6-BLOCK-A DONE; W6-BLOCK-B BLOCKED; W6-BLOCK-C DONE; W6-BLOCK-D DONE; W6-BASE DONE (260729 numerical FAIL); W7-PHYS-AUDIT-MOUNTED-PATH DONE (negative/unclassified); W7-PHYS-OWNER-TERMINAL-VIA-VS-SPATIAL DONE (negative/evidence-unavailable); W7-PHYS-EVIDENCE-MISSING-PATH-COVERAGE DONE (negative/evidence-unavailable); W7-PHYS-PRODUCTION-VIA-ROUTE-SOURCE-TRACE DONE (source-classified raw-base/global finite-route ownership; local calibrated half-branches not selected; mixed ownership fail-closed); W7-PHYS-RAW-FINITE-VIA-RL-GENERATION-TRACE DONE (producer unclassified, high confidence); W7-PHYS-GROUND-REACHABILITY-RL-PRODUCER-TRACE DONE (producer delegated/unclassified, high confidence); W7-PHYS-VIA-SEGMENT-RL-MODEL-TRACE DONE (source-classified model; conditional multi-segment caller-contract bug confirmed; W6 exposure unknown); W7-PHYS-MULTISEGMENT-RL-CALLER-FIX BLOCKED (fixture-contract red; production diff statically accepted and retained uncommitted); W7-PHYS-CORRECTED-SUCCESSOR BLOCKED (static REJECT; zero pytest executions); W7-PHYS-CORRECTED-SUCCESSOR-2 DONE; W7-PHYS-W6-MULTISEGMENT-EXPOSURE DONE (source-classified evidence unavailable; actual exposure unknown); W7-PHYS-PLANE-SHEET-NONUNIFORM-RL-SOURCE-TRACE DONE (local stamps source-classified; Maxwell partial generation external/unclassified); W7-PHYS-MAXWELL-PARTIAL-SOURCE-TRACE DONE (local adjacent-gap dispersive admittance classified; Maxwell C/dispersion/load/solver insertion external); W7-PHYS-MAXWELL-CAPACITANCE-PRODUCER-TRACE DONE (exact 2D polygon-overlay lumped parallel-plate Maxwell C source-classified; W6 inputs/asset fidelity external); W7-PHYS-PLANE-SHEET-RL-REUSE-DISCOVERY DONE (canonical rg once, candidates found; no reuse or production proof); W7-PHYS-COPPER-SURFACE-IMPEDANCE-REUSE-TRACE DONE (surface-impedance constitutive law and MFDM stamp source-classified; W6 reuse unclassified/STOP); W7-PHYS-SURFACE-PATCH-PLANE-REUSE-TRACE DONE (surface-patch local solver/operator source-classified; whole-solver W6 compatibility reuse unclassified/STOP); W7-PHYS-W6-PLANE-SHEET-REIMPLEMENTATION-DESIGN BLOCKED (design before coding; replacement profile decision frozen); W7-PHYS-W6-PLANE-SHEET-ADAPTER-BINDING-TRACE BLOCKED (profile/fallback, worker/cache, raw geometry/material provenance, differential nullspace/final rail-order Zii, and no-double-counting owner transition remain external); W7-PHYS-W6-PLANE-SHEET-INTEGRATION-BINDING-TRACE BLOCKED (source-classified; five acceptance items UNPROVEN; stopped at whitelist-outside delegates); W7-PHYS-W6-PLANE-SHEET-SOURCE-CONTRACT-TRACE BLOCKED (source-classified; approved asset path missing; all joint acceptance unmet); W7-PHYS-W6-PLANE-SHEET-BOUNDED-PATH-DISCOVERY BLOCKED (source-classified; A/B/C insufficient); W7-PHYS-PROSPECTIVE-RUNTIME-TERM-EVIDENCE BLOCKED/YAGNI; W7-PHYS-W6-PROJECTSPEC-PLANE-MATERIAL-OWNER-TRACE BLOCKED (existing-contract gap); W7-PHYS BLOCKED; W7-PHYS-W6-RAW-SPATIAL-V3-TEST-SYMBOL-DISCOVERY DONE (17 lines/5 files, unique compiler test); W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION BLOCKED (test-gate); W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION-S1 BLOCKED (test-gate); W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION-S2 DONE (test-gate PASS; 1 passed in 1.09s); W7-PHYS-W6-RAW-SPATIAL-V3-PERSISTENCE-OWNER-DISCOVERY DONE (26 lines/5 files; source-classified persistence seam); W7-PHYS-W6-RAW-SPATIAL-V3-SPD-ADAPTER-PERSISTENCE-TRACE BLOCKED (source-classified STOP); W7-PHYS-W6-RAW-SPATIAL-V3-MERGE-CALLER-DISCOVERY DONE (clean main 7537c8ebee9109071db54cc84f5562e375bfc07f, 2 lines/1 file; location evidence only); W7-PHYS-W6-RAW-SPATIAL-V3-MERGE-OWNER-BOUNDARY-DISCOVERY DONE (source-location boundary evidence; 1601-line span not reasonably bounded); W7-PHYS-W6-RAW-SPATIAL-V3-COMPILER-MERGE-SYMBOL-DISCOVERY DONE (clean main e4a6704247770cce084fd70fa3d5307f95a3a64a; 4 lines/1 file; 8-line nearest compiler-to-merge span; location evidence only); W7-PHYS-W6-RAW-SPATIAL-V3-COMPILER-MERGE-CALLSITE-TRACE DONE (integration-gap evidence; schema-v2 wiring gap; clean main 300d5aacc6386ad8c55ce6bd198ab207fb1f4597; 38-line read; no downstream persistence claim); W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-TEST-SEAM-DISCOVERY DONE (17AH; clean main d45a23f62ebd417a50498724bdea79ba77d8d041; 22 lines/1 file; bounded location evidence; no test owner selected); W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-TEST-OWNER-BOUNDARY-DISCOVERY BLOCKED (17AI; clean main 0b9e75f5367c12e76e8e06edb652f112d518b69d; exact frozen PowerShell once exit2, zero output; no rerun; failure stage unclassified among silent gates; no inferred cause); W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-TEST-OWNER-BOUNDARY-DIAGNOSTIC DONE (17AJ; clean main 4aaf242dc6da530b600b01e924f4a9c01ab88c01; exact diagnostic once exit0, exactly 4 lines expected file; deterministic owner-location evidence; owner selected); W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-TEST-SEAM-TRACE BLOCKED (17AK; clean main 286e939fce53918465de72f8be9b67d3f1844470; exact A/B excerpts once; source-classified endpoint STOP; B truncates loader call at2505; schema/version/tables/require-plane/tail UNPROVEN; no extension); W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-TEST-TAIL-TRACE DONE (17AL; clean main 7618408f8979d07f6810ed1052cb472b8837b222; exact tail2500-2540 once; natural EOF2524; source-classified test gap; no require_plane_sheet_payload=True; no v3 regression claim); W7-PHYS-W6-RAW-SPATIAL-V3-IMPORT-API-SIGNATURE-TRACE DONE (17AM; clean main 2076ba2764a4ae7614a7fdaa55ee6b208f6fdbad; exact6423-6465 once; complete import_spd_scenario(path: str|Path, *, progress=None, is_cancelled=None) -> ScenarioImport; safe kw-only extension point; setup not truncated); W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-WIRING DONE (17AN; clean main f178f4a12720a30db6f12e0011c79d9e2346bd54; 2 files, 4 insertions/1 deletion; adapter kw-only defaultFalse forwarded; selected test include True + loader require True; Sol static ACCEPT; focused node once exit0 `1 passed in 1.59s`; no rerun; default callers remain v2; no production W6/accuracy claim); W7-PHYS-W6-RAW-SPATIAL-V3-PRODUCTION-IMPORT-CALLER-DISCOVERY DONE (17AO; clean main f9ab13c752f7b9c832e69f1d0a16f54fabd38085; exact query once exit0, 4 lines/2 files; gui/main_window.py line109 import and line1867 actual call; spd_adapter line6423 def and line8070 __all__; ignoring import/def/string yields exactly one app caller gui/main_window.py:1867; location evidence only; no production activation claim); W7-PHYS-W6-RAW-SPATIAL-V3-PRODUCTION-IMPORT-CALLER-TRACE DONE (17AP; clean main d476ce2da4bdb852c8164f2036be07eed8c504b0; exact once read gui/main_window.py 1838-1895 (58 lines); _job_import_spd complete boundary1859-1877; sole call omits include_plane_sheet_payload => default-v2; progress scaled to65%, cancellation forwarded; view prep + _PreparedScenarioImport return; no local try/except or product/profile opt-in; upper error handling unproven; no code/test/production/accuracy claim); W7-PHYS-W6-RAW-SPATIAL-V3-GUI-CALLER-TEST-SEAM-DISCOVERY BLOCKED (17AQ; clean main f79927da0f96adc4a60644aa29388965b0dd6df8; exact authorized rg once exit1 zero output; no rerun; no existing direct _job_import_spd test seam; no source/test/code); W7-PHYS-W6-RAW-SPATIAL-V3-GUI-OPTIN-ACTIVATION DONE (17AR; source-before d20eabf267f06799a4f13caa0dce51357eecd4aa; exactly 1 file/1 insertion `include_plane_sheet_payload=True,` in GUI import call; Sol static ACCEPT; no tests; atomic commit fba20767abfbc357f972f77172f6e7f0a5f67772; no solver/production/accuracy claim); ACTIVE W7-PHYS-W6-RAW-SPATIAL-V3-SOLVER-CONSUMER-DISCOVERY
- 현재 권위 상태: 17T historical BLOCKED; 17U/17V source-classified BLOCKED; 17W DONE (2-line/2-file definition query); 17X source-classified BLOCKED (existing-contract gap); 17Y source-classified BLOCKED (0-match filename query); 17Z DONE (17 lines/5 files, unique compiler test); 17AA `W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION` BLOCKED (test-gate); 17AA-S1 `W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION-S1` BLOCKED (test-gate); 17AA-S2 `W7-PHYS-W6-RAW-SPATIAL-ASSET-V3-EMISSION-S2` DONE (test-gate PASS; 1 passed in 1.09s); 17AB `W7-PHYS-W6-RAW-SPATIAL-V3-PERSISTENCE-OWNER-DISCOVERY` DONE (26 lines/5 files; source-classified persistence seam); 17AC `W7-PHYS-W6-RAW-SPATIAL-V3-SPD-ADAPTER-PERSISTENCE-TRACE` BLOCKED (source-classified STOP); 17AD `W7-PHYS-W6-RAW-SPATIAL-V3-MERGE-CALLER-DISCOVERY` DONE (clean main 7537c8ebee9109071db54cc84f5562e375bfc07f, 2 lines/1 file; location evidence only); 17AE `W7-PHYS-W6-RAW-SPATIAL-V3-MERGE-OWNER-BOUNDARY-DISCOVERY` DONE (source-location boundary evidence; 1601-line span not reasonably bounded); 17AF `W7-PHYS-W6-RAW-SPATIAL-V3-COMPILER-MERGE-SYMBOL-DISCOVERY` DONE (clean main e4a6704247770cce084fd70fa3d5307f95a3a64a, 4 lines/1 file; nearest compiler-to-merge span 8 lines; location evidence only); 17AG `W7-PHYS-W6-RAW-SPATIAL-V3-COMPILER-MERGE-CALLSITE-TRACE` DONE (integration-gap evidence; schema-v2 wiring gap); 17AH `W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-TEST-SEAM-DISCOVERY` DONE (clean main d45a23f62ebd417a50498724bdea79ba77d8d041, 22 lines/1 file; bounded location evidence; no test owner selected); 17AI `W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-TEST-OWNER-BOUNDARY-DISCOVERY` BLOCKED (clean main 0b9e75f5367c12e76e8e06edb652f112d518b69d, exact frozen PowerShell once exit2, zero output; no rerun; silent-gate failure stage unclassified; no inferred cause); 17AJ `W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-TEST-OWNER-BOUNDARY-DIAGNOSTIC` DONE (clean main 4aaf242dc6da530b600b01e924f4a9c01ab88c01, exact diagnostic once exit0, exactly 4 lines expected file; deterministic owner-location evidence; one owner selected); 17AK `W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-TEST-SEAM-TRACE` BLOCKED (clean main 286e939fce53918465de72f8be9b67d3f1844470, exact A2284-2312/B2468-2505 excerpts once; source-classified endpoint STOP; no extension; schema/version/tables/require-plane/tail UNPROVEN); 17AL `W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-TEST-TAIL-TRACE` DONE (clean main 7618408f8979d07f6810ed1052cb472b8837b222; exact tail2500-2540 once, natural EOF2524; source-classified test gap; selected owner viable seam, no v3 regression claim); 17AM `W7-PHYS-W6-RAW-SPATIAL-V3-IMPORT-API-SIGNATURE-TRACE` DONE (clean main 2076ba2764a4ae7614a7fdaa55ee6b208f6fdbad; exact6423-6465 once; complete signature/kw-only defaults/return/setup); 17AN `W7-PHYS-W6-RAW-SPATIAL-V3-ADAPTER-OPTIN-WIRING` DONE (clean main f178f4a12720a30db6f12e0011c79d9e2346bd54; 2 files, 4 insertions/1 deletion; kw-only defaultFalse forwarded; selected test include True + loader require True; Sol static ACCEPT; focused node once exit0 `1 passed in 1.59s`; no rerun; default callers remain v2); 17AO `W7-PHYS-W6-RAW-SPATIAL-V3-PRODUCTION-IMPORT-CALLER-DISCOVERY` DONE (clean main f9ab13c752f7b9c832e69f1d0a16f54fabd38085; exact query once exit0, 4 lines/2 files; unique app caller gui/main_window.py:1867 after ignoring import/def/string; location evidence only; no production activation claim); 17AP `W7-PHYS-W6-RAW-SPATIAL-V3-PRODUCTION-IMPORT-CALLER-TRACE` DONE (clean main d476ce2da4bdb852c8164f2036be07eed8c504b0; exact1838-1895 once; complete _job_import_spd boundary1859-1877; default-v2 call, progress/cancellation and return proven; upper error handling/opt-in unproven); 17AQ `W7-PHYS-W6-RAW-SPATIAL-V3-GUI-CALLER-TEST-SEAM-DISCOVERY` BLOCKED (clean main f79927da0f96adc4a60644aa29388965b0dd6df8; exact rg once exit1 zero output; no rerun; no existing direct test seam; no source/test/code); 17AR `W7-PHYS-W6-RAW-SPATIAL-V3-GUI-OPTIN-ACTIVATION` DONE (source-before d20eabf; 1 file/1 insertion; Sol ACCEPT; no tests; atomic commit fba20767; no solver/production/accuracy claim); ACTIVE `W7-PHYS-W6-RAW-SPATIAL-V3-SOLVER-CONSUMER-DISCOVERY`.
...
| 현재 active work item | `W7-PHYS-W6-RAW-SPATIAL-V3-SOLVER-CONSUMER-DISCOVERY` |
| 다음 권장 묶음 | `W7-PHYS-W6-RAW-SPATIAL-V3-SOLVER-CONSUMER-DISCOVERY` (ACTIVE; one frozen raw-spatial loader/require-plane query) |
| current authorization | S2 focused node PASS remains exact prior evidence (`1 passed in 1.09s`), no rerun/broad-suite/production run. 17AL DONE (source-classified test gap) at clean main `7618408f8979d07f6810ed1052cb472b8837b222`: tail2500-2540 once, natural EOF2524; loader checks hashes but no `require_plane_sheet_payload=True`, only get_via assertions plus rail witness; selected owner viable seam, default-v2/no-v3-regression claims remain. 17AM DONE at clean main `2076ba2764a4ae7614a7fdaa55ee6b208f6fdbad`: exact6423-6465 once, complete `import_spd_scenario(path: str|Path, *, progress=None, is_cancelled=None) -> ScenarioImport`, safe kw-only extension point, setup not truncated. 17AN DONE at clean main `f178f4a12720a30db6f12e0011c79d9e2346bd54` (2 files, 4 insertions/1 deletion; adapter kw-only defaultFalse forwarded; selected test include True + loader require True; Sol static ACCEPT; focused node once exit0 `1 passed in 1.59s`; no rerun; default callers remain v2; no production W6/accuracy claim). 17AO DONE as location evidence at clean main `f9ab13c752f7b9c832e69f1d0a16f54fabd38085`: exact query once exit0, 4 lines/2 files; gui/main_window.py line109 import and line1867 actual call, spd_adapter.py line6423 def and line8070 __all__; ignoring import/def/string yields exactly one app caller `src/spd_decap_pi/gui/main_window.py:1867`; no production activation claim. 17AP DONE at clean main `d476ce2da4bdb852c8164f2036be07eed8c504b0`: exact once read `src/spd_decap_pi/gui/main_window.py` lines1838-1895 (58 lines); `_job_import_spd` complete boundary1859-1877; sole call omits include_plane_sheet_payload => default-v2; progress scaled to65%, cancellation forwarded; view prep + `_PreparedScenarioImport` return; no local try/except or product/profile opt-in; upper error handling unproven; no code/test/production/accuracy claim. 17AQ BLOCKED at clean main `f79927da0f96adc4a60644aa29388965b0dd6df8`: exact authorized rg once exit1 zero output; no rerun; no existing direct `_job_import_spd` test seam; no source/test/code. 17AR DONE at clean main commit `fba20767abfbc357f972f77172f6e7f0a5f67772` (source-before `d20eabf267f06799a4f13caa0dce51357eecd4aa`; exactly 1 file/1 insertion `include_plane_sheet_payload=True,`; Sol static ACCEPT; no tests; no solver/production/accuracy claim). 17AS is the sole ACTIVE authority: exactly once query `rg -n --with-filename --no-heading --color never --glob '*.py' '\b(?:load_raw_spatial_contact_asset|require_plane_sheet_payload)\b' 'src/spd_decap_pi'`; max30 lines/6 files; location evidence only, exclude import/definition/export strings; exactly one actual source caller bound to `require_plane_sheet_payload=True` selects later bounded trace; zero actual caller => DONE-negative producer/no solver consumer and separately documented integration design; multiple/ambiguous/error/over budget => STOP; no file open/code/test/production/profile/solver/accuracy/causal claim.
...
| 고비용 검증 권한 | one frozen 17AN two-file wiring + one Sol static diff are authorized; then exactly one focused node (failure STOP/no rerun); no broad, production, profile, accuracy, or release work |
...
| `W7-PHYS-W6-RAW-SPATIAL-V3-SOLVER-CONSUMER-DISCOVERY` | 17AS | ACTIVE | locate the raw-spatial loader/require-plane consumer | exact once query `rg -n --with-filename --no-heading --color never --glob '*.py' '\b(?:load_raw_spatial_contact_asset|require_plane_sheet_payload)\b' 'src/spd_decap_pi'`; max30 lines/6 files; location evidence only, exclude import/definition/export strings; exactly one actual source caller bound to `require_plane_sheet_payload=True` selects later trace; zero actual caller => DONE-negative producer/no solver consumer and separate integration design; multiple/ambiguous/error/over budget => STOP; no file open/code/test/production/profile/solver/accuracy/causal claim |
...
### 17AS. W7-PHYS-W6-RAW-SPATIAL-V3-SOLVER-CONSUMER-DISCOVERY (ACTIVE)

Run exactly once on the clean docs-commit HEAD:
...
Cap at 30 output lines and 6 files. This is location evidence only: exclude import/definition/export
strings, and require exactly one actual source caller bound to `require_plane_sheet_payload=True` before
selecting a later bounded trace. Zero actual caller => DONE-negative producer/no solver consumer and a
separately documented integration design; multiple/ambiguous/error/over-budget => STOP. No file
open/code/test/production/profile/solver/accuracy/causal claim.
## 20. 변경 기록
