...
- 문서 버전: **1.144**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.143
...
- Sole ACTIVE item (current): 17DM `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-FRESH-RUN`; 17DK permanently BLOCKED/execution STOP and 17DL DONE/PASS.
- The historical chain's terminal `ACTIVE NONE. Any implementation remains gated.` wording is superseded: sole ACTIVE is 17DM under the exact whitelist.
...
| 현재 active work item | 17DM `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-FRESH-RUN` (ACTIVE) |
| 다음 권장 묶음 | 17DM Usage Guard, fresh-root pre-existence check, one production audit/no retry |
| current authorization | exact 17DM audit only; no 17DK output reuse/rerun and no unrelated build/release authority |
...
| `W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-FRESH-RUN` | 17DM | ACTIVE | fresh strict source-coverage production audit | exact raw/candidate hashes; Usage Guard; fresh-root precheck; one run/no retry |
...
### 17DM. W7-PHYS-RAW-SPD-LANDING-CONTACT-STRICT-COVERAGE-AUDIT-FRESH-RUN (ACTIVE)
