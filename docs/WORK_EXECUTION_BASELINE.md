...
- 문서 버전: **1.74**
- 상위 기준: [목적·기술 기준](PRODUCT_PURPOSE_AND_TECHNICAL_BASELINE.md) v1.73
...
- 17AT BLOCKED/implementation REJECT after one frozen-evidence design pass; all six bindings remain UNPROVEN. 17AU DONE (location evidence) at clean main `9f1c95fa0a933445bbb918aff050fcb6238b1e6`. 17AV BLOCKED/STOP after exact read; sole ACTIVE 17AW: `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-OWNER-BOUNDARY-DISCOVERY`.
...
| 현재 active work item | `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-OWNER-BOUNDARY-DISCOVERY` |
| 다음 권장 묶음 | `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-OWNER-BOUNDARY-DISCOVERY` (ACTIVE; one exact owner-boundary query) |
| current authorization | 17AV BLOCKED/STOP: exact evaluation.py2330-2449 read had truncated function/signature and termination/downstream boundaries; no extension. Sole ACTIVE 17AW authorizes one exact PowerShell query; no file open/range/code/test/production/solver/accuracy execution. |
...
| 고비용 검증 권한 | none; only the low-cost bounded 17AW owner-boundary query is authorized, with no file open/range/code/test/production execution |
...
| `W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-OWNER-BOUNDARY-DISCOVERY` | 17AW | ACTIVE | discover evaluation owner boundary | exact once PowerShell definition query on `src/spd_decap_pi/evaluation.py`; exactly 2 lines/1 file, before<=2330, after>2449, span<=240; errors/parse/missing/order/over-span => STOP; location only, no file open/range/code/test/production/solver/accuracy claim |
...
### 17AW. W7-PHYS-W6-RAW-SPATIAL-V3-EVALUATION-OWNER-BOUNDARY-DISCOVERY (ACTIVE)
...
order/over-span => STOP. Location evidence only; no file open/range/code/test/production/solver/accuracy claim.
## 20. 변경 기록
