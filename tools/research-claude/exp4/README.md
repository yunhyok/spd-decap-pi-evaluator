...
- `--which ab`: builds the S2 model once and solves modes `orig`, `a` (Re Zs only), and `b` (symmetric two-sided ½·Zc·coth(γt/2) on L14/L25) at the ladder frequencies → `$SPD_PI_WORK_DIR/exp4/result_S2_*.json`
...
Report: `$SPD_PI_WORK_DIR/exp4/EXP4_REPORT.md`.
