...
- `run8.py --predict`: pre-run prediction table (cell-wise d_eff under the GND-only vs any-net rule × EXP-5 per-layer L) → `/home/claude/work/exp8/prediction.json`.
...
This is a tool-convention mode, not a physical claim. See `/home/claude/work/exp8/EXP8_REPORT.md`.
