    ...
    try:
        ...
        with np.load(PINS['raw'][0],allow_pickle=False) as raw:
            ...
            for index in (0,1,2):
                ...
                retained_coeff=current_coeff.copy();retained_coeff[REMOVED_PARTIALS]=0
                retained,_=recon._build_partial_matrix(ChainMap({'partial_actual_1mhz_dispersion_admittance_scale_s':retained_coeff},raw),surface_lookup=lookup,surface_to_reduced=surface_to_reduced,global_to_active=global_to_active,active_size=N)
