"""SPD Decap PI Evaluator v0.23.1: HQ-owned, bounded finite joint-P experiment."""
import hashlib
...
DRIVER = Path('C:/Users/User/.codex/worktrees/06f1/SPD Decap PI Evaluator/outputs/child-port-fixture/l14-l25-finite-driver-01/finite_l14_l25_driver.py')
DRIVER_SHA = '6f7b89e087fbfbe2ea8dc8f524739942b8d5b3713c65cdcd523d00929d20e719'
...
def run():
    ...
    pins = WORKER.pins(strict=True)
    structural = WORKER.structural_check()
    alpha0 = WORKER.alpha0()
    ...
    return dict(program='SPD Decap PI Evaluator',version='0.23.1',
        ...
        finite_driver_pins=pins,internal_time_limit_s=3300,external_time_limit_s=3600,
        maximum_joint_actions=24,maximum_private_or_working_bytes=32*2**30,
        scope='One current-baseline 1MHz/port18 conditional finite L14/L25 update. L04 remains a separate diagnostic.')


def source_action():
    finite_output = OUTPUT.parent/'finite'
    print('START_FINITE_JOINT_P_BOARD_EXPERIMENT',flush=True)
    report = WORKER.run_alpha1_worker(finite_output,restart=20,maxiter=1,
                                    max_true_actions=24,max_runtime_s=3300)
